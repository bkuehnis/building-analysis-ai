"""
to run:
python -m prediction_model.models.fassaden_daemmung.train_RandomForest
...
MODEL_PATH = PROJECT_ROOT / os.getenv("OUTPUT_MODEL_PATH") / "fassaden_daemmung" / "saved_models"
