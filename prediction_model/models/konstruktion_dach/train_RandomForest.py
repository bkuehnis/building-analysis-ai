"""
to run:
python -m prediction_model.models.konstruktion_dach.train_RandomForest
...
MODEL_PATH = PROJECT_ROOT / os.getenv("OUTPUT_MODEL_PATH") / "konstruktion_dach" / "saved_models"
